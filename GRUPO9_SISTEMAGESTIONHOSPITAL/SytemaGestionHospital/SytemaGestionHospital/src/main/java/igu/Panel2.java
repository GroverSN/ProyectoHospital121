...
public class Panel2 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("estadoClinico");

        jLabel8.setText("nroHabitacion");

        jLabel9.setText("nrocamilla");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
              ...
              int edad= (Integer) jSpinner3.getValue();
              String genero = jTextField3.getText();
              String diagnostico = jTextField4.getText();
              String estadoClinico = jTextField5.getText();
              int nroHabitacion =(Integer) jSpinner1.getValue();
              int nroCamilla=(Integer)jSpinner2.getValue();
              
              if (nombre.isEmpty()|| genero.isEmpty()|| diagnostico.isEmpty()||estadoClinico.isEmpty()|| fechaIngreso.isEmpty()){
                  javax.swing.JOptionPane.showMessageDialog(this,"Todos los campos deben estar llenados");
              }else{
              PacienteDAO pacienteDAO = new PacienteDAO();
              try{
                  pacienteDAO.insertarPaciente(nombre,edad,genero,diagnostico,fechaIngreso,estadoClinico,nroHabitacion,nroCamilla);
                  javax.swing.JOptionPane.showMessageDialog(this,"Paciente REgistrado");
                  limpiarCampos();
              }catch (Exception e){
        javax.swing.JOptionPane.showMessageDialog(this,"no se pudo registrar al paciente");
    }}
